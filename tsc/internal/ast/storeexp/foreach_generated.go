...
// The cases are in Kind order and cover every kind that has a slot.
...
func forEachChildImportTypeNode(n Node, v Visitor) bool {
	s, data := n.s, n.h.data
	if ref := NodeRef(s.extra[data+0]); ref != 0 && v(s.node(ref)) { // Argument
		return true
	}
	if ref := NodeRef(s.extra[data+1]); ref != 0 && v(s.node(ref)) { // Attributes
		return true
	}
	if ref := NodeRef(s.extra[data+2]); ref != 0 && v(s.node(ref)) { // Qualifier
		return true
	}
	if at := s.extra[data+3]; at != 0 && visitList(s, at, v) { // TypeArguments
		return true
	}
	return false
}
...
func forEachChildSyntheticExpression(n Node, v Visitor) bool {
	s, data := n.s, n.h.data
	if ref := NodeRef(s.extra[data+0]); ref != 0 && v(s.node(ref)) { // TupleNameSource
		return true
	}
	return false
}
...
func forEachChildModuleDeclaration(n Node, v Visitor) bool {
	...
	if ref := NodeRef(s.extra[data+3]); ref != 0 && v(s.node(ref)) { // Body
		return true
	}
	return false
}
...
func forEachChildImportEqualsDeclaration(n Node, v Visitor) bool {
	...
	if ref := NodeRef(s.extra[data+2]); ref != 0 && v(s.node(ref)) { // ModuleReference
		return true
	}
	return false
}
...
func forEachChildImportClause(n Node, v Visitor) bool {
	...
	if ref := NodeRef(s.extra[data+1]); ref != 0 && v(s.node(ref)) { // NamedBindings
		return true
	}
	return false
}
...
func forEachChildImportSpecifier(n Node, v Visitor) bool {
	s, data := n.s, n.h.data
	if ref := NodeRef(s.extra[data+0]); ref != 0 && v(s.node(ref)) { // PropertyName
		return true
	}
	if ref := NodeRef(s.extra[data+1]); ref != 0 && v(s.node(ref)) { // name
		return true
...
func forEachChildExportDeclaration(n Node, v Visitor) bool {
	...
	if ref := NodeRef(s.extra[data+1]); ref != 0 && v(s.node(ref)) { // ExportClause
		return true
	}
	if ref := NodeRef(s.extra[data+2]); ref != 0 && v(s.node(ref)) { // ModuleSpecifier
		return true
...
func forEachChildImportAttributes(n Node, v Visitor) bool {
	s, data := n.s, n.h.data
	if at := s.extra[data+0]; at != 0 && visitList(s, at, v) { // Attributes
		return true
	}
	return false
}
...
func forEachChildJSDocParameterOrPropertyTag(n Node, v Visitor) bool {
	...
	if ref := NodeRef(s.extra[data+2]); ref != 0 && v(s.node(ref)) { // TypeExpression
		return true
	}
	if at := s.extra[data+3]; at != 0 && visitList(s, at, v) { // Comment
		return true
