...
type EmitHost interface {
	...
	Options( // NOTE: EmitHost operations must be thread-safe
...
func newEmitHost(ctx context.Context, program *Program, file *ast.SourceFile) (*emitHost, func()) {
	...
	return &emitHost{program: program, emitResolver: checker.GetEmitResolver()}, done
}
func (host *emitHost) GetModeForUsageLocation(file ast.HasFileName, moduleSpecifier ast.Handle) core.ResolutionMode {
	return host.program.GetModeForUsageLocation(file, moduleSpecifier)
}
func (host *emitHost) GetResolvedModuleFromModuleSpecifier(file ast.HasFileName, moduleSpecifier ast.Handle) *module.ResolvedModule {
...
func (host *emitHost) GetEffectiveDeclarationFlags(node ast.Handle, flags ast.ModifierFlags) ast.ModifierFlags {
...
func (host *emitHost) GetResolutionModeOverride(node ast.Handle) core.ResolutionMode {
