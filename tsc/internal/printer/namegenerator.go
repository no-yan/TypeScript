...
type NameGenerator struct {
	...
	nodeIdToGeneratedName              map[ast.GlobalRef]string  // Map of generated names for specific nodes
	nodeIdToGeneratedPrivateName       map[ast.GlobalRef]string  // Map of generated private names for specific nodes
...
func (g *NameGenerator) generateNameForNodeCached(node *ast.Node, privateName bool, flags GeneratedIdentifierFlags, prefix string, suffix string) string {
	nodeId := ast.GlobalRef(ast.GetNodeId(node))
	if g.Context != nil {
