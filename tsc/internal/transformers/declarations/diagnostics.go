...
func wrapSimpleDiagnosticSelector(node ast.Handle, selector func(node ast.Handle, symbolAccessibilityResult printer.SymbolAccessibilityResult) *diagnostics.Message) GetSymbolAccessibilityDiagnostic {
	return func(symbolAccessibilityResult printer.SymbolAccessibilityResult) *SymbolAccessibilityDiagnostic {
		...
		return &SymbolAccessibilityDiagnostic{errorNode: node, diagnosticMessage: diagnosticMessage, typeName: ast.GetNameOfDeclaration(node)}
	}
}
func wrapNamedDiagnosticSelector(node ast.Handle, selector func(node ast.Handle, symbolAccessibilityResult printer.SymbolAccessibilityResult) *diagnostics.Message) GetSymbolAccessibilityDiagnostic {
	return func(symbolAccessibilityResult printer.SymbolAccessibilityResult) *SymbolAccessibilityDiagnostic {
		diagnosticMessage := selector(node, symbolAccessibilityResult)
		if diagnosticMessage == nil {
			return nil
		...
		return &SymbolAccessibilityDiagnostic{errorNode: name, diagnosticMessage: diagnosticMessage, typeName: name}
	}
}
func wrapFallbackErrorDiagnosticSelector(node ast.Handle, selector func(node ast.Handle, symbolAccessibilityResult printer.SymbolAccessibilityResult) *diagnostics.Message) GetSymbolAccessibilityDiagnostic {
	return func(symbolAccessibilityResult printer.SymbolAccessibilityResult) *SymbolAccessibilityDiagnostic {
		diagnosticMessage := selector(node, symbolAccessibilityResult)
		if diagnosticMessage == nil {
			return nil
		...
		return &SymbolAccessibilityDiagnostic{errorNode: errorNode, diagnosticMessage: diagnosticMessage}
	}
}
...
func createGetSymbolAccessibilityDiagnosticForNodeName(node ast.Handle) GetSymbolAccessibilityDiagnostic {
...
func createGetSymbolAccessibilityDiagnosticForNode(node ast.Handle) GetSymbolAccessibilityDiagnostic {
	if ast.IsVariableDeclaration(node) || ast.IsPropertyDeclaration(node) || ast.IsPropertySignatureDeclaration(node) || ast.IsPropertyAccessExpression(node) || ast.IsElementAccessExpression(node) || ast.IsBinaryExpression(node) || ast.IsBindingElement(node) || ast.IsConstructorDeclaration(node) {
		...
		return func(symbolAccessibilityResult printer.SymbolAccessibilityResult) *SymbolAccessibilityDiagnostic {
			...
			if ast.IsClassDeclaration(node.Parent().Parent()) {
				if ast.IsHeritageClause(node.Parent()) && node.Parent().HeritageClauseToken() == ast.KindImplementsKeyword {
					diagnosticMessage = diagnostics.Implements_clause_of_exported_class_0_has_or_is_using_private_name_1
				} else {
					if !node.Parent().Parent().Name().IsNil() {
			...
			return &SymbolAccessibilityDiagnostic{diagnosticMessage: diagnosticMessage, errorNode: node, typeName: ast.GetNameOfDeclaration(node.Parent().Parent())}
		}
	} else if ast.IsImportEqualsDeclaration(node) {
		return wrapSimpleDiagnosticSelector(node, func(_ ast.Handle, _ printer.SymbolAccessibilityResult) *diagnostics.Message {
		...
		return func(symbolAccessibilityResult printer.SymbolAccessibilityResult) *SymbolAccessibilityDiagnostic {
			diagnosticMessage := selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Exported_type_alias_0_has_or_is_using_private_name_1_from_module_2, diagnostics.Exported_type_alias_0_has_or_is_using_private_name_1)
			errorNode := node.Type()
			typeName := node.Name()
		...
		return func(symbolAccessibilityResult printer.SymbolAccessibilityResult) *SymbolAccessibilityDiagnostic {
			diagnosticMessage := selectDiagnosticBasedOnModuleName(symbolAccessibilityResult, diagnostics.Exported_variable_0_has_or_is_using_name_1_from_external_module_2_but_cannot_be_named, diagnostics.Exported_variable_0_has_or_is_using_name_1_from_private_module_2, diagnostics.Exported_variable_0_has_or_is_using_private_name_1)
...
func getAccessorDeclarationTypeVisibilityDiagnosticMessage(node ast.Handle, symbolAccessibilityResult printer.SymbolAccessibilityResult) *diagnostics.Message {
	if node.Kind == ast.KindSetAccessor {
		if ast.IsStatic(node) {
			...
			return selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Parameter_type_of_public_setter_0_from_exported_class_has_or_is_using_name_1_from_private_module_2, diagnostics.Parameter_type_of_public_setter_0_from_exported_class_has_or_is_using_private_name_1)
		}
	} else {
		if ast.IsStatic(node) {
			return selectDiagnosticBasedOnModuleName(symbolAccessibilityResult, diagnostics.Return_type_of_public_static_getter_0_from_exported_class_has_or_is_using_name_1_from_external_module_2_but_cannot_be_named, diagnostics.Return_type_of_public_static_getter_0_from_exported_class_has_or_is_using_name_1_from_private_module_2, diagnostics.Return_type_of_public_static_getter_0_from_exported_class_has_or_is_using_private_name_1)
		} else {
...
func getReturnTypeVisibilityDiagnosticMessage(node ast.Handle, symbolAccessibilityResult printer.SymbolAccessibilityResult) *diagnostics.Message {
	...
	case ast.KindCallSignature:
		return selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Return_type_of_call_signature_from_exported_interface_has_or_is_using_name_0_from_private_module_1, diagnostics.Return_type_of_call_signature_from_exported_interface_has_or_is_using_private_name_0)
	case ast.KindIndexSignature:
		return selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Return_type_of_index_signature_from_exported_interface_has_or_is_using_name_0_from_private_module_1, diagnostics.Return_type_of_index_signature_from_exported_interface_has_or_is_using_private_name_0)
...
func getParameterDeclarationTypeVisibilityDiagnosticMessage(node ast.Handle, symbolAccessibilityResult printer.SymbolAccessibilityResult) *diagnostics.Message {
	...
	case ast.KindConstructSignature, ast.KindConstructorType:
		return selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Parameter_0_of_constructor_signature_from_exported_interface_has_or_is_using_name_1_from_private_module_2, diagnostics.Parameter_0_of_constructor_signature_from_exported_interface_has_or_is_using_private_name_1)
	case ast.KindCallSignature:
		return selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Parameter_0_of_call_signature_from_exported_interface_has_or_is_using_name_1_from_private_module_2, diagnostics.Parameter_0_of_call_signature_from_exported_interface_has_or_is_using_private_name_1)
	case ast.KindIndexSignature:
		return selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Parameter_0_of_index_signature_from_exported_interface_has_or_is_using_name_1_from_private_module_2, diagnostics.Parameter_0_of_index_signature_from_exported_interface_has_or_is_using_private_name_1)
	case ast.KindMethodDeclaration, ast.KindMethodSignature:
...
func isDeclarationEnoughForErrors(node ast.Handle) bool {
...
func isFunctionLikeAndNotConstructor(node ast.Handle) bool {
	return ast.IsFunctionLikeDeclaration(node) && !ast.IsConstructorDeclaration(node)
}
func findNearestDeclaration(node ast.Handle) ast.Handle {
...
func createEntityInTypeNodeError(node ast.Handle) *ast.Diagnostic {
...
func addParentDeclarationRelatedInfo(node ast.Handle, diag *ast.Diagnostic) {
	parentDeclaration := findNearestDeclaration(node)
	if parentDeclaration.IsNil() {
		return
	}
	targetStr := ""
...
func createClassExpressionError(node ast.Handle) *ast.Diagnostic {
...
func isParentForIDDIagnostic(node ast.Handle) ast.FindAncestorResult {
...
func createExpressionErrorEx(node ast.Handle, diagnosticMessage *diagnostics.Message) *ast.Diagnostic {
	parentDeclaration := findNearestDeclaration(node)
	if parentDeclaration.IsNil() {
		if diagnosticMessage == nil {
...
func createGetIsolatedDeclarationErrors(resolver printer.EmitResolver) func(node ast.Handle) *ast.Diagnostic {
	createParameterError := func(node ast.Handle) *ast.Diagnostic {
		if ast.IsSetAccessorDeclaration(node.Parent()) {
			return createAccessorTypeError(node.Parent())
		}
		addUndefined := resolver.RequiresAddingImplicitUndefinedUnsafe(node, nil, ast.Handle{})
